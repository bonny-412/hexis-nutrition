...
- **Colore del delta nella sezione Andamento/striscia statistiche del dettaglio paziente fisso (giù=verde, su=rosso) per tutte le metriche** (2026-09-02): ragionevole default per peso/BMI/%grasso in un contesto di dimagrimento, ma inverso per un paziente sottopeso in fase di recupero — l'app non ha oggi nessuna nozione di "direzione favorevole" per paziente/metrica. Segnalato ad Andrea durante la revisione finale del lavoro sui grafici, non ancora deciso. Vedi [stato](stato.md).
